...
`;
        ...
        const newResult = (0, adapter_2.organizeImportsNew)(input, { blankLinesAfterImports: 'legacy' });
        ...
        console.log('===\n');
        assert_1.strict.equal(newResult, oldResult, 'Should match old behavior (legacy mode)');
    });
...
`;
        ...
        console.log(newResult);
        console.log('===\n');
        assert_1.strict.equal(newResult, oldResult, 'Blank line before imports should be handled correctly');
    });
...
`;
        ...
        console.log(newResult);
        console.log('===\n');
        assert_1.strict.equal(newResult, oldResult, 'Should have blank line between import groups');
    });
...
`;
        const oldResult = await (0, adapter_1.organizeImportsOld)(input);
        const newResult = (0, adapter_2.organizeImportsNew)(input, { blankLinesAfterImports: 'legacy' });
        assert_1.strict.equal(newResult, oldResult, 'Leading blank lines should be removed');
    });
...
`;
        ...
        assert_1.strict.equal(newTrimmed, oldTrimmed, 'Should handle files with code after imports');
    });
...
`;
        ...
        console.log(newResult);
        console.log('===\n');
        assert_1.strict.equal(newResult, oldResult, 'Shebang should be preserved at file start');
    });
...
`;
        const oldResult = await (0, adapter_1.organizeImportsOld)(input);
        const newResult = (0, adapter_2.organizeImportsNew)(input, { blankLinesAfterImports: 'legacy' });
        assert_1.strict.equal(newResult, oldResult, 'use strict should be preserved before imports');
    });
...
`;
        const oldResult = await (0, adapter_1.organizeImportsOld)(input);
        const newResult = (0, adapter_2.organizeImportsNew)(input, { blankLinesAfterImports: 'legacy' });
        assert_1.strict.equal(newResult, oldResult, 'Copyright header should be preserved');
    });
...
`;
        ...
        console.log(newResult);
        console.log('===\n');
        assert_1.strict.equal(newResult, oldResult, 'Should handle multiple blank lines (legacy mode)');
    });
...
`;
        const oldResult = await (0, adapter_1.organizeImportsOld)(input);
        const newResult = (0, adapter_2.organizeImportsNew)(input, { blankLinesAfterImports: 'legacy' });
        assert_1.strict.equal(newResult, oldResult, 'No blank line before imports when no header');
    });
...
`;
        ...
        console.log(newResult);
        console.log('===\n');
        assert_1.strict.equal(newResult, oldResult, 'Block comment should be preserved');
    });
...
`;
        ...
        console.log(newResult);
        console.log('===\n');
        assert_1.strict.equal(newResult, oldResult, 'Three groups should have blank lines between each');
    });
...
`;
        ...
        console.log(newResult);
        console.log('===\n');
        assert_1.strict.equal(newResult, oldResult, 'Blank line after header should be preserved');
    });
});
//# sourceMappingURL=05-blank-lines.test.js.map