...
`;
        ...
        console.log('===\n');
        assert_1.strict.equal(newResult, oldResult, 'New extension must match old extension output');
    });
...
`;
        const oldResult = await (0, adapter_1.organizeImportsOld)(input);
        const newResult = (0, adapter_2.organizeImportsNew)(input);
        assert_1.strict.equal(newResult, oldResult, 'Should match for all-capital specifiers');
    });
...
`;
        const oldResult = await (0, adapter_1.organizeImportsOld)(input);
        const newResult = (0, adapter_2.organizeImportsNew)(input);
        assert_1.strict.equal(newResult, oldResult, 'Should match for all-lowercase specifiers');
    });
...
`;
        ...
        console.log(newResult);
        console.log('===\n');
        assert_1.strict.equal(newResult, oldResult, 'Should handle complex mixed-case scenarios');
    });
...
`;
        const oldResult = await (0, adapter_1.organizeImportsOld)(input);
        const newResult = (0, adapter_2.organizeImportsNew)(input);
        assert_1.strict.equal(newResult, oldResult, 'Libraries should be sorted alphabetically');
    });
...
`;
        ...
        const oldResult = await (0, adapter_1.organizeImportsOld)(input, { organizeSortsByFirstSpecifier: true });
        ...
        console.log(newResult);
        console.log('===\n');
        assert_1.strict.equal(newResult, oldResult, 'Should sort by first specifier when enabled');
    });
...
`;
        ...
        console.log(newResult);
        console.log('===\n');
        assert_1.strict.equal(newResult, oldResult, 'String imports should come before named imports');
    });
...
`;
        ...
        assert_1.strict.equal(newResult, oldResultWithoutTrailingBlank, 'String imports should be sorted alphabetically');
    });
...
`;
        ...
        console.log(newResult);
        console.log('===\n');
        assert_1.strict.equal(newResult, oldResult, 'Aliases should be sorted by original name, not alias');
    });
...
`;
        ...
        assert_1.strict.equal(newResult, oldResult, 'Default import should come before named imports');
    });
...
`;
        const oldResult = await (0, adapter_1.organizeImportsOld)(input);
        const newResult = (0, adapter_2.organizeImportsNew)(input);
        assert_1.strict.equal(newResult, oldResult, 'Namespace imports should be sorted by alias');
    });
...
`;
        const oldResult = await (0, adapter_1.organizeImportsOld)(input);
        const newResult = (0, adapter_2.organizeImportsNew)(input);
        assert_1.strict.equal(newResult, oldResult, 'Library names should be sorted case-insensitively');
    });
...
`;
        ...
        console.log(newResult);
        console.log('===\n');
        assert_1.strict.equal(newResult, oldResult, 'Numbers in names should be sorted correctly');
    });
...
`;
        const oldResult = await (0, adapter_1.organizeImportsOld)(input);
        const newResult = (0, adapter_2.organizeImportsNew)(input);
        assert_1.strict.equal(newResult, oldResult, 'Scoped packages should be sorted correctly');
    });
});
//# sourceMappingURL=01-sorting.test.js.map