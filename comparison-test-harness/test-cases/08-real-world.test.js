...
`;
        ...
        console.log('===\n');
        assert_1.strict.equal(newResult, oldResult, 'Angular standalone component imports should be organized correctly');
    });
...
`;
        ...
        console.log(newResult);
        console.log('===\n');
        assert_1.strict.equal(newResult, oldResult, 'React component with hooks should be organized correctly');
    });
...
`;
        ...
        console.log(newResult);
        console.log('===\n');
        assert_1.strict.equal(newResult, oldResult, 'NestJS controller imports should be organized correctly');
    });
...
`;
        ...
        console.log(newResult);
        console.log('===\n');
        assert_1.strict.equal(newResult, oldResult, 'Vue 3 composition API imports should be organized correctly');
    });
...
`;
        ...
        console.log(newResult);
        console.log('===\n');
        assert_1.strict.equal(newResult, oldResult, 'RxJS operators should be organized correctly');
    });
...
`;
        const oldResult = await (0, adapter_1.organizeImportsOld)(input);
        const newResult = (0, adapter_2.organizeImportsNew)(input);
        assert_1.strict.equal(newResult, oldResult, 'Express route handler imports should be organized correctly');
    });
...
`;
        ...
        console.log(newResult);
        console.log('===\n');
        assert_1.strict.equal(newResult, oldResult, 'Node.js module with built-ins should be organized correctly');
    });
...
`;
        ...
        console.log(newResult);
        console.log('===\n');
        assert_1.strict.equal(newResult, oldResult, 'Monorepo packages should be organized correctly');
    });
...
`;
        const oldResult = await (0, adapter_1.organizeImportsOld)(input);
        const newResult = (0, adapter_2.organizeImportsNew)(input);
        assert_1.strict.equal(newResult, oldResult, 'Mixed framework imports should be sorted alphabetically');
    });
...
`;
        ...
        console.log(newResult);
        console.log('===\n');
        assert_1.strict.equal(newResult, oldResult, 'Large files with many imports should be handled efficiently');
    });
});
//# sourceMappingURL=08-real-world.test.js.map